...
--
-- Хост: localhost
-- Время создания: Ноя 28 2018 г., 01:48
...
ALTER TABLE `authors` ADD FULLTEXT KEY `name_author_2` (`name_author`);
...
ALTER TABLE `books` ADD FULLTEXT KEY `name_book_2` (`name_book`);
...
ALTER TABLE `genres` ADD FULLTEXT KEY `name_genre` (`name_genre`);
